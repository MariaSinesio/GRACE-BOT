...
client.on(Events.GuildMemberAdd, async member => {
    ...
    \nPedimos que olhe o canal de <#1525580993627426856> para tirar dúvidas ou escreva ${botPrefix}**faq** para acessar as perguntas mais frequentes.
    \n Visite o canal de <#1540355097811222568> para visualizar os avisos emitidos pela organização.
